...
execute positioned ~ ~-0.234 ~ unless block ~ ~ ~ tnt if score temp_0 tnt_data matches 1 run summon tnt ~ ~ ~ {Fuse:100s,Passengers:[ {id:"minecraft:armor_stand",Tags:["icytnt_icy","icytnt_primed"],Fire:32000s,Marker:1b,Invisible:1,Invulnerable:1,NoGravity:1,DisabledSlots:2039583,ArmorItems:[{},{},{},{id:"minecraft:blast_furnace",Count:1b,tag:{CustomModelData:6441006}}]} ]}
...
execute positioned ~ ~-0.234 ~ unless block ~ ~ ~ tnt if score temp_0 tnt_data matches 1 run loot spawn ~ ~ ~ loot icytnt:icy_tnt
