...
execute if entity @s[tag=du_moving] as @e[tag=du_click_entity,type=villager,tag=du_click_1] if score @s du_data = temp_0 du_data positioned ~ ~0.5 ~ run tp @s ^0.5 ^ ^1
execute if entity @s[tag=du_moving] as @e[tag=du_click_entity,type=villager,tag=du_click_2] if score @s du_data = temp_0 du_data positioned ~ ~0.5 ~ run tp @s ^ ^ ^1.5
execute if entity @s[tag=du_moving] as @e[tag=du_click_entity,type=villager,tag=du_click_3] if score @s du_data = temp_0 du_data positioned ~ ~0.5 ~ run tp @s ^-0.5 ^ ^1
