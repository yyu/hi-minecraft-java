...
#load data
execute store result score temp_3 du_data run data get block -29999999 0 1600 RecordItem.tag.du.struct_reg_end[0].size
execute store result score temp_4 du_data run data get block -29999999 0 1600 RecordItem.tag.du.struct_reg_end[0].weight
execute store result score temp_5 du_data run data get block -29999999 0 1600 RecordItem.tag.du.struct_reg_end[0].isBlacklist
...
execute if score temp_6 du_data matches 1 if score temp_5 du_data matches 0..1 run function du:world/generation/struct_gen/check_biomes_end
...
execute if score temp_6 du_data matches 1 run data modify block -29999999 0 1600 RecordItem.tag.du.temp_struct_list append from block -29999999 0 1600 RecordItem.tag.du.struct_reg_end[0]
